...
@class IDOBloodGlucoseCurrentInfo;
@class IDOBloodGlucoseStatisticsInfo;
@class IDOBloodGlucoseHistoryDataInfo;
enum IDOAlgorithmSensorSwitch : NSInteger;
@class IDORawDataSensorConfigReply;
@class IDOMenuListV3Model;
@class IDOEmotionHealthReminderParamModel;
...
/// 更新当前血糖数据
+ (id <IDOCancellable> _Nonnull)uploadBloodGlucoseCurrentData:(IDOBloodGlucoseCurrentInfo * _Nonnull)item completion:(void (^ _Nonnull)(CmdError * _Nonnull, IDOCmdSetResponseModel * _Nullable))completion;
/// 更新血糖统计数据
+ (id <IDOCancellable> _Nonnull)uploadBloodGlucoseStatisticsData:(IDOBloodGlucoseStatisticsInfo * _Nonnull)item completion:(void (^ _Nonnull)(CmdError * _Nonnull, IDOCmdSetResponseModel * _Nullable))completion;
/// 更新血糖CGM历史数据
+ (id <IDOCancellable> _Nonnull)uploadBloodGlucoseHistoryData:(IDOBloodGlucoseHistoryDataInfo * _Nonnull)item completion:(void (^ _Nonnull)(CmdError * _Nonnull, IDOCmdSetResponseModel * _Nullable))completion;
/// 开始算法原始数据采集
+ (id <IDOCancellable> _Nonnull)startAlgorithmRawDataDAQ:(void (^ _Nonnull)(CmdError * _Nonnull, IDOCmdSetResponseModel * _Nullable))completion;
/// 结束算法原始数据采集
+ (id <IDOCancellable> _Nonnull)stopAlgorithmRawDataDAQ:(void (^ _Nonnull)(CmdError * _Nonnull, IDOCmdSetResponseModel * _Nullable))completion;
/// 设置算法原始数据采集配置
+ (id <IDOCancellable> _Nonnull)setAlgorithmRawDataSensorConfigWithPpg:(enum IDOAlgorithmSensorSwitch)ppg acc:(enum IDOAlgorithmSensorSwitch)acc completion:(void (^ _Nonnull)(CmdError * _Nonnull, IDOCmdSetResponseModel * _Nullable))completion;
/// 查询算法原始数据采集配置
+ (id <IDOCancellable> _Nonnull)getAlgorithmRawDataSensorConfig:(void (^ _Nonnull)(CmdError * _Nonnull, IDORawDataSensorConfigReply * _Nullable))completion;
/// 查询v3菜单列表
+ (id <IDOCancellable> _Nonnull)getMenuListV3:(void (^ _Nonnull)(CmdError * _Nonnull, IDOMenuListV3Model * _Nullable))completion;
/// 设置v3菜单列表
+ (id <IDOCancellable> _Nonnull)setMenuListV3WithItems:(NSArray<NSNumber *> * _Nonnull)items completion:(void (^ _Nonnull)(CmdError * _Nonnull, IDOCmdSetResponseModel * _Nullable))completion;
/// 情绪健康提醒 （设置 / 查询）
...
SWIFT_CLASS("_TtC16protocol_channel14IDOAccDataItem")
@interface IDOAccDataItem : NSObject
@property (nonatomic) int16_t x;
@property (nonatomic) int16_t y;
@property (nonatomic) int16_t z;
- (nonnull instancetype)initWithX:(int16_t)x y:(int16_t)y z:(int16_t)z OBJC_DESIGNATED_INITIALIZER;
...
/// 跳绳详情
SWIFT_CLASS("_TtC16protocol_channel23IDOActivityRopeSkipItem")
@interface IDOActivityRopeSkipItem : NSObject
@property (nonatomic) NSInteger ropeSkipCount;
...
/// 分段详情
SWIFT_CLASS("_TtC16protocol_channel22IDOActivitySegmentItem")
@interface IDOActivitySegmentItem : NSObject
...
/// 游泳趟次（15.20 v52，见 IDOAppActivityDataV3ExchangeModel.md）
SWIFT_CLASS("_TtC16protocol_channel26IDOActivitySwimmingLapItem")
@interface IDOActivitySwimmingLapItem : NSObject
@property (nonatomic) NSInteger swolf;
@property (nonatomic) NSInteger swimmingPosture;
@property (nonatomic) NSInteger strokesNumber;
@property (nonatomic) NSInteger duration;
@property (nonatomic) NSInteger distance;
...
typedef SWIFT_ENUM(NSInteger, IDOAlgorithmSensorSwitch, open) {
  IDOAlgorithmSensorSwitchInvalid = -1,
  IDOAlgorithmSensorSwitchOpen = 1,
  IDOAlgorithmSensorSwitchClose = 0,
};
...
/// app 获取v3多运动数据（15.20 运动小结，见 IDOAppActivityDataV3ExchangeModel.md）
...
@property (nonatomic) NSInteger segmentItemNum;
@property (nonatomic) NSInteger segmentTotalTime;
@property (nonatomic) NSInteger segmentTotalDistance;
@property (nonatomic) NSInteger segmentTotalPace;
@property (nonatomic) NSInteger segmentTotalAvgHr;
@property (nonatomic) NSInteger segmentTotalAvgStepFrequency;
@property (nonatomic) NSInteger paceHiit;
@property (nonatomic) NSInteger paceAnaerobic;
@property (nonatomic) NSInteger paceLacticAcidThreshold;
@property (nonatomic) NSInteger paceMarathon;
@property (nonatomic) NSInteger paceEasyRun;
@property (nonatomic, copy) NSArray<IDOActivitySegmentItem *> * _Nullable segmentItems;
@property (nonatomic) NSInteger cumulativeClimb;
@property (nonatomic) NSInteger cumulativeDecline;
@property (nonatomic) NSInteger minStepStride;
@property (nonatomic) NSInteger minStepFrequency;
@property (nonatomic) NSInteger slowestKmPace;
@property (nonatomic) NSInteger heartRateZonesMode;
@property (nonatomic) NSInteger minSpeed;
@property (nonatomic) NSInteger easyZoneTime;
@property (nonatomic) NSInteger marathonZoneTime;
@property (nonatomic) NSInteger thresholdZoneTime;
@property (nonatomic) NSInteger anaerobicZoneTime;
@property (nonatomic) NSInteger intervalZoneTime;
@property (nonatomic) NSInteger actType;
...
@property (nonatomic) NSInteger maxAltitude;
@property (nonatomic) NSInteger minAltitude;
@property (nonatomic) NSInteger avgAltitude;
@property (nonatomic) NSInteger altitudeCount;
@property (nonatomic, copy) NSArray<NSNumber *> * _Nullable altitudeItem;
...
SWIFT_CLASS("_TtC16protocol_channel30IDOBloodGlucoseHistoryDataItem")
@interface IDOBloodGlucoseHistoryDataItem : NSObject
@property (nonatomic) uint32_t date;
@property (nonatomic) NSInteger glucoseVal;
@property (nonatomic) NSInteger targetUnit;
- (nonnull instancetype)initWithDate:(uint32_t)date glucoseVal:(NSInteger)glucoseVal targetUnit:(NSInteger)targetUnit OBJC_DESIGNATED_INITIALIZER;
- (NSString * _Nullable)toJsonString SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
typedef SWIFT_ENUM(NSInteger, IDOCgmPhoneCommandErrCode, open) {
  IDOCgmPhoneCommandErrCodeSuccess = 0,
  IDOCgmPhoneCommandErrCodeInvalidKey = 1,
  IDOCgmPhoneCommandErrCodeInvalidDeviceName = 2,
  IDOCgmPhoneCommandErrCodeStorageFail = 3,
  IDOCgmPhoneCommandErrCodeNoKey = 4,
  IDOCgmPhoneCommandErrCodeBusy = 5,
  IDOCgmPhoneCommandErrCodeScanTimeout = 6,
  IDOCgmPhoneCommandErrCodePairFlag = 7,
  IDOCgmPhoneCommandErrCodeConnectFail = 8,
  IDOCgmPhoneCommandErrCodeKeyReadFail = 9,
  IDOCgmPhoneCommandErrCodeProtocolFail = 10,
  IDOCgmPhoneCommandErrCodeDisconnectFail = 11,
};


/// CGM 手机下发指令回复
SWIFT_CLASS("_TtC16protocol_channel23IDOCgmPhoneCommandModel")
@interface IDOCgmPhoneCommandModel : NSObject
@property (nonatomic) NSInteger version;
@property (nonatomic) NSInteger operate;
@property (nonatomic) NSInteger errCode;
...
@class IDORawDataSensorInfoReply;
...
/// 监听算法原始数据采集（全局监听一次）
- (void)listenReceiveAlgorithmRawDataWithRawDataReply:(void (^ _Nonnull)(IDORawDataSensorInfoReply * _Nonnull))rawDataReply;
@end
...
- (void)getActivityExchangeFullSnapshotWithCompletion:(void (^ _Nonnull)(NSString * _Nullable))completion;
/// 获取多运动一分钟心率数据
...
SWIFT_CLASS("_TtC16protocol_channel24IDODeviceStatusInfoModel")
@interface IDODeviceStatusInfoModel : NSObject
/// 查询类型掩码；默认 1（运动状态）| Query type mask; default 1 (sport status)
@property (nonatomic) NSInteger getType;
/// 是否包含 sportStartType | Whether sportStartType is included in the reply
@property (nonatomic) BOOL hasSportStartType;
/// \param getType 查询类型掩码 | Query type mask
///
- (nonnull instancetype)initWithGetType:(NSInteger)getType OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// 设备振动与铃声 | Device vibration and ringtone
SWIFT_CLASS("_TtC16protocol_channel31IDODeviceVibrationRingtoneModel")
@interface IDODeviceVibrationRingtoneModel : NSObject
/// 操作类型：1 查询 / 2 设置 | Operation: 1 query / 2 set
@property (nonatomic) NSInteger operate;
/// 设备支持的振动强度列表 | Supported vibration intensity levels
@property (nonatomic, copy) NSArray<NSNumber *> * _Nullable supportedVibrationIntensity;
- (NSString * _Nullable)toJsonString SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@class IDOPressureRemindConfig;
@class IDOUnpleasantRemindConfig;

SWIFT_CLASS("_TtC16protocol_channel34IDOEmotionHealthReminderParamModel")
@interface IDOEmotionHealthReminderParamModel : NSObject
...
@property (nonatomic) NSInteger emotionalHealthSwitch;
/// Pressure reminder configuration
@property (nonatomic, strong) IDOPressureRemindConfig * _Nullable pressureRemind;
/// Unpleasant reminder configuration
@property (nonatomic, strong) IDOUnpleasantRemindConfig * _Nullable unpleasantRemind;
- (nonnull instancetype)initWithOperate:(NSInteger)operate notifyType:(NSInteger)notifyType emotionalHealthSwitch:(NSInteger)emotionalHealthSwitch pressureRemind:(IDOPressureRemindConfig * _Nullable)pressureRemind unpleasantRemind:(IDOUnpleasantRemindConfig * _Nullable)unpleasantRemind OBJC_DESIGNATED_INITIALIZER;
- (NSString * _Nullable)toJsonString SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC16protocol_channel34IDOEmotionHealthReminderReplyModel")
@interface IDOEmotionHealthReminderReplyModel : NSObject
/// Operation type: 0:Invalid 1:Set 2:Query
@property (nonatomic) NSInteger operate;
...
/// Unpleasant reminder configuration
@property (nonatomic, strong) IDOUnpleasantRemindConfig * _Nullable unpleasantRemind;
- (nonnull instancetype)initWithOperate:(NSInteger)operate errorCode:(NSInteger)errorCode notifyType:(NSInteger)notifyType emotionalHealthSwitch:(NSInteger)emotionalHealthSwitch pressureRemind:(IDOPressureRemindConfig * _Nullable)pressureRemind unpleasantRemind:(IDOUnpleasantRemindConfig * _Nullable)unpleasantRemind OBJC_DESIGNATED_INITIALIZER;
- (NSString * _Nullable)toJsonString SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// 获取寻找手机开关状态（GET:0x02/0x26）回复
SWIFT_CLASS("_TtC16protocol_channel23IDOFindPhoneSwitchModel")
@interface IDOFindPhoneSwitchModel : NSObject
...
/// other
@property (nonatomic, readonly) BOOL reminderOther;
/// Matters
...
/// 国内版微博
@property (nonatomic, readonly) BOOL reminderWeibo;
/// 来电提醒
...
/// 淘宝
@property (nonatomic, readonly) BOOL reminderTaobao;
/// 钉钉
@property (nonatomic, readonly) BOOL reminderDingding;
/// 支付宝
@property (nonatomic, readonly) BOOL reminderAlipay;
/// 今日头条
@property (nonatomic, readonly) BOOL reminderToutiao;
/// 抖音
@property (nonatomic, readonly) BOOL reminderDouyin;
/// 天猫
@property (nonatomic, readonly) BOOL reminderTmall;
/// 京东
@property (nonatomic, readonly) BOOL reminderJd;
/// 拼多多
@property (nonatomic, readonly) BOOL reminderPinduoduo;
/// 百度
@property (nonatomic, readonly) BOOL reminderBaidu;
/// 美团
@property (nonatomic, readonly) BOOL reminderMeituan;
/// 饿了么
@property (nonatomic, readonly) BOOL reminderEleme;
/// v2 走路
...
/// v2 健身操
@property (nonatomic, readonly) BOOL sportBodybuildingExercise;
/// v2 瑜伽
...
/// 血氧过低提醒通知提醒类型
@property (nonatomic, readonly) BOOL setSpo2LowValueRemindAddNotifyFlag;
/// 智能心率提醒通知提醒类型
@property (nonatomic, readonly) BOOL notSupportSmartHeartNotifyFlag;
/// 获取重启日志错误码和标志位
...
/// v3经期历史数据支持交互、支持固件删除
@property (nonatomic, readonly) BOOL supportSetHistoricalMenstruationExchangeVersion21;
/// v3经期历史数据支持交互、支持固件删除
@property (nonatomic, readonly) BOOL supportHistoricalMenstruationExchangeVersion31;
/// v3女性生理日常记录设置
@property (nonatomic, readonly) BOOL supportPhysiologicalRecord;
/// v2经期提醒设置 增加易孕期和结束时间
...
/// 支持同步血氧使用version字段兼容
@property (nonatomic, readonly) BOOL getSupportSyncSpo2UseVersionCompatible;
/// 支持同步压力使用version字段兼容
@property (nonatomic, readonly) BOOL getSupportSyncPressureUseVersionCompatible;
/// v3天气设置增加下发48小时天气数据
...
/// 支持查询、设置 v3菜单列表
@property (nonatomic, readonly) BOOL supportProtocolV3MenuList;
/// 中文
...
/// 支持设置应用列表样式
@property (nonatomic, readonly) BOOL supportOperateListStyle;
/// 支持情绪健康
@property (nonatomic, readonly) BOOL supportEmotionHealth;
/// 支持v3同步通讯录版本20
@property (nonatomic, readonly) BOOL supportV3SyncContactVersion20;
/// 支持SOS通话记录查询
@property (nonatomic, readonly) BOOL supportGetSosCallRecord;
...
/// 支持获取运动是否支持自动暂停结束
@property (nonatomic, readonly) BOOL supportSportGetAutoPauseEnd;
/// 支持步幅长度的单位设置(公制/英制)
...
/// 设备是否不支持拍照推流
@property (nonatomic, readonly) BOOL notSupportPhotoPreviewControl;
/// 支持获取用户信息
@property (nonatomic, readonly) BOOL supportGetUserInfo;
/// 支持未接来电消息类型为485
@property (nonatomic, readonly) BOOL supportMissedCallMsgTypeUseFixed;
/// 支持闹钟不显示闹钟名称
@property (nonatomic, readonly) BOOL supportAppNotDisplayAlarmName;
/// 支持设置睡眠提醒
...
/// CGM 手机下发指令（15.107）
@property (nonatomic, readonly) BOOL supportCgmPhoneCommand;
/// 支持算法数据的采集
...
@property (nonatomic) NSInteger endMinute;
/// Measurement interval in seconds
/// Optional, default 0 (0 means not supported)
@property (nonatomic) NSInteger measurementInterval;
...
SWIFT_CLASS("_TtC16protocol_channel18IDOMenuListV3Model")
@interface IDOMenuListV3Model : NSObject
/// 操作类型
/// <ul>
///   <li>
///     1: 设置
...
@property (nonatomic) NSInteger currentShowNum;
/// 支持显示个数，查询操作时有效
@property (nonatomic) NSInteger supportMaxNum;
...
///
/// \endcode
@property (nonatomic, copy) NSArray<NSNumber *> * _Nullable itemList;
- (nonnull instancetype)initWithVersion:(NSInteger)version operate:(NSInteger)operate errorCode:(NSInteger)errorCode minShowNum:(NSInteger)minShowNum maxShowNum:(NSInteger)maxShowNum currentShowNum:(NSInteger)currentShowNum supportMaxNum:(NSInteger)supportMaxNum itemList:(NSArray<NSNumber *> * _Nullable)itemList OBJC_DESIGNATED_INITIALIZER;
- (NSString * _Nullable)toJsonString SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (IDODeviceModel * _Nonnull)toDeviceModel SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic) uint32_t infrared;
@property (nonatomic) uint32_t red;
- (nonnull instancetype)initWithGreen:(uint32_t)green infrared:(uint32_t)infrared red:(uint32_t)red OBJC_DESIGNATED_INITIALIZER;
- (NSString * _Nullable)toJsonString SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// Pressure reminder configuration
SWIFT_CLASS("_TtC16protocol_channel23IDOPressureRemindConfig")
@interface IDOPressureRemindConfig : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@class IDOSensorConfig;

SWIFT_CLASS("_TtC16protocol_channel27IDORawDataSensorConfigReply")
@interface IDORawDataSensorConfigReply : NSObject
@property (nonatomic) NSInteger errCode;
@property (nonatomic, strong) IDOSensorConfig * _Nullable configItem;
- (nonnull instancetype)initWithErrCode:(NSInteger)errCode operate:(NSInteger)operate configItem:(IDOSensorConfig * _Nullable)configItem OBJC_DESIGNATED_INITIALIZER;
- (NSString * _Nullable)toJsonString SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC16protocol_channel25IDORawDataSensorInfoReply")
@interface IDORawDataSensorInfoReply : NSObject
@property (nonatomic) NSInteger year;
@property (nonatomic) NSInteger month;
@property (nonatomic) NSInteger day;
@property (nonatomic) NSInteger hour;
...
@property (nonatomic) NSInteger dataType;
@property (nonatomic) NSInteger frequency;
@property (nonatomic, copy) NSArray<IDOAccDataItem *> * _Nullable accDataItems;
@property (nonatomic, copy) NSArray<IDOPpgDataItem *> * _Nullable ppgDataItems;
- (nonnull instancetype)initWithYear:(NSInteger)year month:(NSInteger)month day:(NSInteger)day hour:(NSInteger)hour min:(NSInteger)min sec:(NSInteger)sec dataType:(NSInteger)dataType frequency:(NSInteger)frequency accDataCount:(NSInteger)accDataCount ppgDataCount:(NSInteger)ppgDataCount accDataItems:(NSArray<IDOAccDataItem *> * _Nullable)accDataItems ppgDataItems:(NSArray<IDOPpgDataItem *> * _Nullable)ppgDataItems OBJC_DESIGNATED_INITIALIZER;
- (NSString * _Nullable)toJsonString SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC16protocol_channel15IDOSensorConfig")
@interface IDOSensorConfig : NSObject
@property (nonatomic) enum IDOAlgorithmSensorSwitch ppgSwitch;
@property (nonatomic) enum IDOAlgorithmSensorSwitch accSwitch;
- (nonnull instancetype)initWithPpgSwitch:(enum IDOAlgorithmSensorSwitch)ppgSwitch accSwitch:(enum IDOAlgorithmSensorSwitch)accSwitch OBJC_DESIGNATED_INITIALIZER;
- (NSString * _Nullable)toJsonString SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic) NSInteger notifyFlag;
/// 测量间隔（分钟）| Measurement interval in minutes
/// Optional, default 0
@property (nonatomic) NSInteger measurementInterval;
- (nonnull instancetype)initOnOff:(NSInteger)onOff startHour:(NSInteger)startHour startMinute:(NSInteger)startMinute endHour:(NSInteger)endHour endMinute:(NSInteger)endMinute lowSpo2OnOff:(NSInteger)lowSpo2OnOff lowSpo2Value:(NSInteger)lowSpo2Value notifyFlag:(NSInteger)notifyFlag measurementInterval:(NSInteger)measurementInterval OBJC_DESIGNATED_INITIALIZER;
- (NSString * _Nullable)toJsonString SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// 踏步训练
  IDOSportTypeSportTypeSteppingTraining = 44,
/// 上肢训练
  IDOSportTypeSportTypeUpperBodyTraining = 45,
/// 混合有氧
  IDOSportTypeSportTypeMixedCardio = 46,
/// 背部训练
  IDOSportTypeSportTypeBackTraining = 47,
/// 户外跑步
...
/// 无挡板篮球
  IDOSportTypeSportTypeNetball = 142,
/// 箭步蹲(Lunge)
  IDOSportTypeSportTypeLunge = 149,
/// 弓箭步
  IDOSportTypeSportTypeArcherStep = 150,
/// 拉伸
  IDOSportTypeSportTypeStretching = 151,
/// 街舞
...
/// 越野跑
  IDOSportTypeSportTypeTrailRunning = 189,
/// 卷腹
  IDOSportTypeSportTypeCrunch = 190,
/// 波比跳
  IDOSportTypeSportTypeBurpee = 191,
/// 卡巴迪
  IDOSportTypeSportTypeKabaddi = 192,
/// 户外玩耍(KR01)
  IDOSportTypeSportTypeOutdoorFun = 193,
/// 其他运动(KR01)
  IDOSportTypeSportTypeOtherActivity = 194,
/// 蹦床
  IDOSportTypeSportTypeTrampoline = 195,
/// 呼啦圈
  IDOSportTypeSportTypeHulaHoop = 196,
/// 赛车
  IDOSportTypeSportTypeRacing = 197,
/// 战绳
  IDOSportTypeSportTypeBattlingRope = 198,
/// 跳伞
...
/// 需设置左右手佩戴类型的运动类型列表 | Sport types requiring wrist-side setting
SWIFT_CLASS("_TtC16protocol_channel43IDOSportTypesRequiringWristSideSettingModel")
@interface IDOSportTypesRequiringWristSideSettingModel : NSObject
/// 错误码；0 成功 | Error code; 0 success
@property (nonatomic) NSInteger errorCode;
/// 运动类型个数；0 表示空列表 | Number of sport types; 0 means empty list
@property (nonatomic) NSInteger typeCount;
/// 运动类型编码列表，长度与 typeCount 一致 | Sport type codes; length matches typeCount
...
/// Unpleasant reminder configuration
SWIFT_CLASS("_TtC16protocol_channel25IDOUnpleasantRemindConfig")
@interface IDOUnpleasantRemindConfig : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
